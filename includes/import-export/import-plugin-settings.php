 ...
 * @since	3.2.7
 */
add_action( 'admin_init', 'wp_crm_system_import_settings' );
function wp_crm_system_import_settings() {
	if( isset( $_POST['wpcrm-settings-duplicate-contact'] ) ) {
		update_option( 'wpcrm-settings-duplicate-contact', sanitize_text_field( $_POST['wpcrm-settings-duplicate-contact'] ) );
	}
}