...
/**
 * Since v3.2.8, we will be introducing a custom post satuts for duplicate contact
 * 
 * @since	3.2.8
 */
function wpcrm_duplicate_contact_status(){
	register_post_status( 'duplicate-contact', array(
		'label'                     => _x( 'Duplicate', 'post' ),
		'public'                    => false,
		'exclude_from_search'       => true,
...
add_action( 'init', 'wpcrm_duplicate_contact_status' );