...
function wpcrm_system_task_fields( $fields ) {
  $taskFields = array(
    array(
      ...
      'style'					=> 'wp-crm-first',
      'before'				=> '<div class="wp-crm-first wp-crm-one-half wp-crm-task-edit-page"><div class="wp-crm-inline attach-to-organization">',
      'after'					=> '</div>',
    ...
    array(
      ...
      'notification'  => __( 'Enable Contact Notification', 'wp-crm-system' ),
      'description'   => '',
      'placeholder'   => '',
      'type'          => 'selectcontact',
      'scope'         => array( 'wpcrm-task' ),
      'style'					=> '',
      'before'				=> '<div class="wp-crm-first wp-crm-inline attach-to-contact">',
      'after'					=> '</div>',
      'icon'					=> 'dashicons dashicons-id wpcrm-dashicons',
      'capability'    => WPCRM_USER_ACCESS
    ),
    array(
      'name'          => 'task-notify-contact',
      'title'         => __( 'Enable Contact Notification', 'wp-crm-system' ),
      'description'   => '',
      'placeholder'   => '',
      'type'          => 'notifycontact',
      'scope'         => array( 'wpcrm-task' ),
      'style'					=> '" style="display:flex; align-items:center;"',
      'before'				=> '<div class="wp-crm-first">',
      'after'					=> '</div>',
      'icon'					=> 'dashicons dashicons-id wpcrm-dashicons',
      'capability'    => WPCRM_USER_ACCESS
    ),
    array(
      ...
      'scope'         => array( 'wpcrm-task' ),
      'style'					=> '',
      'before'				=> '<div class="wp-crm-first wp-crm-inline attach-to-project">',
      'after'					=> '</div>',
