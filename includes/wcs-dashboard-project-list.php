...
function wpcrm_system_dashboard_projects_js($hook){
	wp_enqueue_script( 'wp_crm_system_dashboard_project_list', WP_CRM_SYSTEM_PLUGIN_URL . '/assets/dist/scripts/dashboard-project-list.js', array( 'jquery' ), WP_CRM_SYSTEM_VERSION, false );
