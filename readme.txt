...
= 3.2.9 =
* Fix: PHP Fatal and warnings when generating reports
* Fix: Bugs on exporting report
= 3.2.7.2 =
* New: Option on how you want the system handles the duplicate entries
* Fix: Opportunity to Project conversion bugs
* Fix: Duplicate import of Contacts
= 3.2.7.1 =
* Fix: Break line on email content
= 3.2.7 =
